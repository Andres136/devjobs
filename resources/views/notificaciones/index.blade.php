        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="min-h-[115px] overflow-hidden rounded-md bg-gray-800 pb-8">
                ...
                @forelse ( $notificaciones as $notificacion )
                    <div class="mx-5 mb-4 flex items-center justify-between rounded-lg border border-gray-200 bg-white p-5 text-left text-gray-800 shadow-sm">
                        <div>
                        ...
                        <a href="#" class="ml-4 shrink-0 rounded-lg bg-indigo-500 p-3 text-sm font-bold uppercase text-white">Ver Candidatos</a>
                    </div>
                @empty
